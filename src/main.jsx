    ...
    <main>
      ...
      <div className="page">
        ...
        <section className="metrics">
          <Metric icon={Building2} label="管理物件" value="12" unit="件" note="稼働中 12件" />
